import { AlertTriangle, Clock, Users, Gauge, ShieldAlert } from "lucide-react"
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-4 text-3xl font-bold tracking-tight text-foreground sm:text-4xl text-balance">
            Viele Unternehmen besitzen Security Tools – aber keine Security Operations.
          </h2>
          <p className="mt-4 text-lg text-muted-foreground">
            Die grösste Lücke in der IT-Sicherheit ist nicht die Technologie – es sind die fehlenden Prozesse und das fehlende Personal.
          </p>
        </div>
